...
import { complete, type Message } from "@repi/ai";
import type { ExtensionAPI, SessionEntry } from "@repi/coding-agent";
import { BorderedLoader, convertToLlm, serializeConversation } from "@repi/coding-agent";
