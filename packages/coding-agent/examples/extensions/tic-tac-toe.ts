...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@repi/coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@repi/tui";
