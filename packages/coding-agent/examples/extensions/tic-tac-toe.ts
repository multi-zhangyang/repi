...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@pi-recon/repi-coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@pi-recon/repi-tui";
