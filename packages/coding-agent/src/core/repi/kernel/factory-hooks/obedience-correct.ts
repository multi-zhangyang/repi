...
const REBUTTALS: Record<ObedienceViolation["kind"], string> = {
	...
	missing_closeout: [
		...
		"Never merge HARNESS_BUGS and PROOF on one line. If a real tool error=true exists, list it under HARNESS_BUGS; target findings stay under PROOF.",
	].join("\n"),
	harness_mislabel: [
		...
		"Never merge HARNESS_BUGS and PROOF on one line.",
