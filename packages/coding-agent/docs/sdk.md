...
```typescript
import { createAgentSession, SessionManager } from "@repi/coding-agent";
...
The `Agent` class (from `@repi/agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
import { AuthStorage, ModelRegistry } from "@repi/coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@repi/coding-agent";
...
```typescript
import { createAgentSession } from "@repi/coding-agent";
...
import { createAgentSession, defineTool } from "@repi/coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@repi/coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@repi/coding-agent";
