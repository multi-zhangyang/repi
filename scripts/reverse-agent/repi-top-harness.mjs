...
function staticContractChecks() {
	...
	checks.push(markerCheck("npm:top-harness-script", "package.json", ["gate:repi-harness", "gate:repi-product", "gate:repi-isolation", "gate:repi-product-surface", "gate:context-compact", "gate:compact-resume-chain", "gate:memory-contract", "gate:memory-utility", "gate:memory-feedback", "gate:memory-hybrid", "gate:memory-distiller", "gate:worker-runtime-pool", "gate:worker-child-session", "install:repi", "clean:repi-legacy-profile"], ["install:recon-pi", "gate:pi-recon-primary"]));
