...
function staticContractChecks() {
	...
	checks.push(markerCheck("code:queued-custom-trigger-turn", "packages/coding-agent/src/core/agent-session.ts", ["_continueQueuedMessages", "this.agent.steer(appMessage)", 'options.deliverAs === "steer"', "await this._continueQueuedMessages()", "hasSummarizableHistory"], []));
	checks.push(markerCheck("code:generic-400-no-body-not-overflow", "packages/ai/src/utils/overflow.ts", ["noBody400", 'provider === "cerebras"', "!noBody400"], []));
	...
	checks.push(markerCheck("model:cloudflare-kimi-2-7-code-built-in", "packages/ai/src/models.generated.ts", ["@cf/moonshotai/kimi-k2.7-code", "workers-ai/@cf/moonshotai/kimi-k2.7-code", "Kimi K2.7 Code", "contextWindow: 262144", "cacheRead: 0.19"], []));
...
function childGateChecks() {
	const gates = [
		...
		["gate:repi-mcp", ["scripts/reverse-agent/repi-mcp-gate.mjs", root, "--strict"]],
